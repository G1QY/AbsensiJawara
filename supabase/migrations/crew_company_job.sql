BEGIN;
ALTER TABLE public.crew ADD COLUMN IF NOT EXISTS company_name text NOT NULL DEFAULT '' CHECK (length(company_name)<=150);
ALTER TABLE public.crew ADD COLUMN IF NOT EXISTS job_title text NOT NULL DEFAULT '' CHECK (length(job_title)<=100);
