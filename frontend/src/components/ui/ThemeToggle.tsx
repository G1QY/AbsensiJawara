...
export default function ThemeToggle() {
  ...
  return <button type="button" className="ui-icon" title={theme === 'dark' ? translateUI("Ubah ke tema terang") : translateUI("Ubah ke tema gelap")} aria-label={theme === 'dark' ? translateUI("Ubah ke tema terang") : translateUI("Ubah ke tema gelap")} onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
