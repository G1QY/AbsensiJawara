...
export function payrollSheet(rows:PayrollRow[],month:string,rules:PayrollRules){return [['Periode','Nama','Perusahaan','Jabatan','Jenis','Dasar Gaji','Tarif Pokok','Unit','Gaji Pokok','Hari Terjadwal','Hari Absen','Tarif Harian','Potongan Absen','Jam Telat','Tarif Potongan/Jam','Potongan Telat','Total Potongan','Jam Lembur Disetujui','Tarif Lembur/Jam','Bonus','Estimasi','Catatan Dikecualikan'],...rows.map(r=>[month,r.crew.user.full_name,r.crew.company_name||'',r.crew.job_title||'',r.crew.crew_type,r.basis,r.baseRate,r.units,r.base,r.scheduledDays,r.absentDays,r.dailyRate,r.absenceDeduction,r.lateHours,rules.lateRate,r.lateDeduction,r.deduction,r.overtimeHours,rules.overtimeRate,r.bonus,r.total,r.excluded])];}
